...
>abstract="對此功能的存取權取決於您對Adobe Experience Cloud Generative AI使用者指南的同意，以及下列各項： (a)您為此功能提供的任何提示、內容、補充資訊或其他輸入都必須與特定內容連結，其中可能包括您的品牌推廣材料、網站內容、資料、此類資料的結構描述、範本或其他受信任檔案，以及(b)不得包含任何個人資訊（個人資訊包括可連結回特定個人的任何內容）。 您應該檢閱此功能的任何輸出是否準確，並確定它適合您的使用案例。"

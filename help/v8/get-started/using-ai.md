...
[內容說明中建議問題的範例](assets/do-not-localize/suggested-questions.png){width="600"}{zoomable="yes"}
...
[在內容說明中複製答案的範例](assets/do-not-localize/copy-answer.png){width="600"}{zoomable="yes"}

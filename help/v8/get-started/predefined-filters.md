...
1. 選取「**建立新篩選器**」，然後輸入該篩選器的名稱和說明。
   ...
   如果需要，您可以將篩選器儲存為最愛。 若要了解更多資訊，請參閱[此區段](#fav-filter)。 您也可以啟用「**[!UICONTROL 共用篩選器]**」選項，讓其他使用者可以存取該篩選器。 若要了解更多資訊，請參閱[此區段](#share-filter)。
...
此篩選器便會新增至預先定義的篩選器清單。 如果需要，您可以將篩選器儲存為最愛。 若要了解更多資訊，請參閱[此區段](#fav-filter)。 您也可以啟用&#x200B;**[!UICONTROL 共用篩選器]**&#x200B;選項，將篩選器與其他使用者共用。 若要了解更多資訊，請參閱[此區段](#share-filter)。

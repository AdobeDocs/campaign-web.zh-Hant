...
✨ 透過我們的 [AI 助理](../v8/content/generative-gs.md)即時功能預覽，讓自己沉浸在實作體驗中，以便親身探索並充分了解其功能。
...
<table style="table-layout:auto">
  <tr style="border: 0;">
    ...
    <br/>
      <strong>開始使用</strong><br/><a href="get-started/get-started.md#web">使用者介面</a>，<a href="get-started/connect-to-campaign.md">連線至 Campaign</a>，<a href="get-started/permissions.md">存取權與權限</a>
    </td>
    <td>
...
* [電子郵件追蹤像素和 CNIL 指引](https://experienceleague.adobe.com/zh-hant/docs/campaign/campaign-v8/new/cnil-pixel-tracking){target="_blank"}
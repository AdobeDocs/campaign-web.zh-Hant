...
在Campaign Web使用者介面中，交易式訊息設定的第一步是建立範本或直接建立訊息。 這與使用者端主控台[上的](https://experienceleague.adobe.com/en/docs/campaign/campaign-v8/send/real-time/transactional)異動訊息組態不同。

...
>[!AVAILABILITY]
>
>此功能需要更新Campaign v8.6.3 <!--or v8.7.2-->。 深入瞭解Campaign v8使用者端主控台[發行說明](https://experienceleague.adobe.com/zh-Hant/docs/campaign/campaign-v8/releases/release-notes)。

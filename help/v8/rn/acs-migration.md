...
Campaign網頁使用者介面是專為行銷人員所設計，可輕鬆建立及協調其行銷活動。 讓我們更深入瞭解Campaign v8網頁使用者介面將提供您哪些重要功能：
...
Campaign使用者端主控台是專為管理員和開發人員所設計，可設定和自訂其環境。 Campaign使用者端主控台中可用的主要功能在[此檔案](https://experienceleague.adobe.com/en/docs/campaign/campaign-v8/new/whats-new){target="_blank"}中有詳細說明。

>[!NOTE]
>
>在此頁面](../get-started/capability-matrix.md)中進一步瞭解支援和不支援的功能，以及Campaign Web使用者介面與Campaign使用者端主控台[之間的互通性
>
...
為了讓您順利轉換到 Campaign v8，Campaign v8 中新增了關鍵的 Campaign Standard 功能。這些設定在[此檔案](https://experienceleague.adobe.com/docs/experience-cloud/campaign/campaign-standard-migration-home.html){target="_blank"}中有詳細說明，且僅適用於從Campaign Standard轉換的使用者。

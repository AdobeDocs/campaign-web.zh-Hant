...
>title="傳遞範本"
>abstract="為了加速和改進設計流程，您可以建立傳遞範本，在多個行銷活動中輕鬆重複使用自訂內容和設定。這項功能可以將創意外觀和風格標準化，以更快速地執行和啟動行銷活動"

為了加速和改進設計流程，您可以建立傳遞範本，在多個行銷活動中輕鬆重複使用自訂內容和設定。這項功能可以將創意外觀和風格標準化，以更快速地執行和啟動行銷活動

...
* 建立&#x200B;**條件式內容**
  ...
  例如，設定條件式內容以根據收件者的輪廓新增動態個人化。特定條件為真時，即可插入文字區塊及/或影像。[了解更多](../personalization/conditions.md)

* 新增&#x200B;**個人化產品建議**

  可根據收件者位置、目前的天氣或上次的採購訂單，在您的訊息內容中插入個人化產品建議。[了解更多](../msg/offers.md)

## 預覽和測試您的傳遞 

定義訊息內容後，即可進行預覽以控制訊息的呈現，並使用測試輪廓檢查個人化設定。[了解更多](../preview-test/preview-test.md)

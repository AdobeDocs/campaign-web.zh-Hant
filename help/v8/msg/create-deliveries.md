...
1. 開啟您的傳遞，並瀏覽至&#x200B;**[!UICONTROL 排程]**&#x200B;區段。
1. 使用&#x200B;**[!UICONTROL 啟用排程]**&#x200B;切換以啟動它。
1. 在&#x200B;**[!UICONTROL 聯絡日期]**&#x200B;欄位中，按一下行事曆圖示並設定所要的傳送日期和時間。
1. 在&#x200B;**[!UICONTROL 時區]**&#x200B;欄位中，使用下拉式功能表來選取想要的時區。

傳送傳遞後，實際傳送將從您定義的聯絡日期開始。

![顯示傳遞排程介面的熒幕擷圖](assets/schedule.png){zoomable="yes"}

預設會選取「**[!UICONTROL 啟用傳送前確認]**」選項。此選項會要求您在排程日期傳送傳遞前確認傳送，若您需要在排程日期及時間自動傳送傳遞，您可以停用此選項.me。

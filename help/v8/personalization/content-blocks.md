...
* **[!UICONTROL 專有名詞的格式函式]**：產生&#x200B;**[!UICONTROL toSmartCase]** JavaScript函式，這會將每個字的第一個字母變更為大寫。
...
>[!NOTE]
>
>您可以從Adobe Campaign v8主控台定義新區塊，以讓您將傳送個人化最佳化。 深入瞭解[Campaign v8 （使用者端主控台）檔案](https://experienceleague.adobe.com/docs/campaign/campaign-v8/campaigns/send/personalize/personalization-blocks.html#create-custom-personalization-blocks){target="_blank"}。

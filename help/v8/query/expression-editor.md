...
| 從&#x200B;**屬性**&#x200B;欄位存取 | 從&#x200B;**值**&#x200B;欄位存取 |
| --- | --- |
| ![屬性欄位](assets/expression-editor-attribute.png){zoomable="yes"}{width="200" align="center" zoomable="yes"}的運算式編輯器 | 值欄位](assets/edit-expression.png){zoomable="yes"}{width="200" align="center" zoomable="yes"}的![運算式編輯器 |
...
<td>傳回字串類型欄的值的串連，以第二個引數中的字元分隔</td>
...
<td>傳回一個數字，表示該日期是該週的星期幾 (0=星期一，6=星期日)</td>
<td>WeekDay(&lt;date&gt;)</td>
</tr>
<tr>

...
行銷活動會提供專門的報告量度，藉以全面洞察整個行銷活動的效能。這些量度有助於評估效益、識別趨勢並根據資料做出能將未來工作最佳化的決策。若要探索如何存取和了解行銷活動報告，請參閱[此區段](../reporting/campaign-reports.md)。
...
* [設定及管理核准流程](campaign-approvals.md)

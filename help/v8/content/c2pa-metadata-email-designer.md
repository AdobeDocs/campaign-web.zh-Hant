...
**在此頁面上：**&#x200B;瞭解C2PA中繼資料在Adobe Campaign Web使用者介面中透過電子郵件和登入頁面設計工具移動時，已附加至影像的情形。
...
C2PA中繼資料會隨著影像在Adobe Campaign Web使用者介面中的電子郵件和登陸頁面設計工具中移動，從您的編輯器到儲存體再到收件者的收件匣或即時頁面。 在以上任何步驟中，都不會建立、變更或移除認證。

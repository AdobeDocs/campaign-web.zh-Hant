...
「產生內容」可簡化跨管道（例如電子郵件、簡訊和推播通知）行銷活動的建立與執行，節省時間、改善效率，並取得更好的結果。

>[!IMPORTANT]
>
>* 使用此功能之前，請先檢閱相關的[護欄和限制](#generative-guardrails)。
>
>* 您必須先同意[使用者合約](https://www.adobe.com/tw/legal/licenses-terms/adobe-dx-gen-ai-user-guidelines.html)，才能使用AI在Adobe Campaign網頁中產生內容。 如需詳細資訊，請聯絡您的 Adobe 代表。

## 存取權產生內容 {#generative-access}

產生電子郵件、推播通知、登陸頁面和簡訊的內容現在為「一般可用性(GA)」，可供所有使用者使用。 授予使用者存取權的必要許可權和步驟詳述如下。

+++ 瞭解如何指派內容產生相關許可權

1. **存取[Admin Console](https://adminconsole.adobe.com/)**，瀏覽至&#x200B;**產品**&#x200B;功能表，然後選取&#x200B;**Adobe Campaign Managed Cloud**。

1. 存取您要授與許可權的執行個體，然後按一下&#x200B;**新增設定檔**，以使用下列特定產品設定檔名稱建立新的產品設定檔：

   `Campaign - <instance-name> - AIAssistant`

1. 設定具有「產生內容」存取許可權的產品設定檔。

1. **新增使用者或使用者群組**。 選擇下列其中一個選項：
   * **新增個別使用者**：將必要的使用者直接新增至產品設定檔。
   * **新增使用者群組**：建立使用者群組，將使用者新增至該群組，然後將使用者群組新增至產品設定檔。
...
以下列出使用AI在Adobe Campaign Web中產生內容以產生電子郵件的一般准則：
...
* 目前僅支援在Adobe Campaign網頁版中產生內容。 非英文輸入可能會產生不一致或錯誤的結果。 非英文回覆所引起的問題目前無法解決或改善。
* 僅適用於電子郵件、推播和簡訊頻道。
...
<img alt="[使用「產生內容」產生完整內容]" src="assets/do-not-localize/text-genai.jpeg">
</a>
<div>
產生內容時產生<a href="generative-full-content.md"><strong>完整內容</strong></a>
</div>
<p>
</td>
<td>
<a href="generative-text.md">
<img alt="[使用產生內容產生文字內容]" src="assets/do-not-localize/image-genai.jpeg">
</a>
<div>產生含產生內容的<a href="generative-text.md"><strong>文字</strong>
</div>
<p>
</td>
<td>
<a href="generative-image.md">
<img alt="[使用產生內容產生影像]" src="assets/do-not-localize/email-genai.jpeg">
</a>
<div>
產生含產生內容的<a href="generative-image.md"><strong>影像</strong></a>
</div>
<p></td>
</tr></table>
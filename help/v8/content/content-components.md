...
1. 在電子郵件設計工具中，使用現有內容或將&#x200B;**[!UICONTROL 結構元件]**&#x200B;拖放到您的空白內容以定義電子郵件的版面。[了解作法](create-email-content.md)
...
1. 使用右側的「**[!UICONTROL 元件設定]**」窗格來調整每個元件的樣式屬性。例如，您可以變更每個元件的文字樣式、邊框間距或邊界。[進一步了解對齊方式和邊框間距](alignment-and-padding.md)

   ![](assets/email_designer_content_components_settings.png)

從頭開始建立電子郵件內容時，**[!UICONTROL 內容元件]**可讓您使用原始的空白元件進一步個人化您的電子郵件，這些元件一放入電子郵件中就可以使用。
您可以在定義您電子郵件版面的**[!UICONTROL 結構元件]**&#x200B;內新增所需數量的&#x200B;**[!UICONTROL 內容元件]**。
...
1. 按一下您新增的按鈕以個人化文字，並存取電子郵件設計工具右窗格中的&#x200B;**[!UICONTROL 元件設定]**。

   ![](assets/email_designer_14.png)

1. 在&#x200B;**[!UICONTROL 連結]**&#x200B;欄位，新增按下按鈕時會重新導向到的 URL。
...
使用&#x200B;**[!UICONTROL 文字]**&#x200B;元件將文字插入電子郵件，並調整樣式 (邊框、大小、邊框間距等。)使用 **[!UICONTROL 元件設定]**&#x200B;窗格。

1. 從&#x200B;**[!UICONTROL 內容元件]**，將&#x200B;**[!UICONTROL 文字]**&#x200B;拖放到&#x200B;**[!UICONTROL 結構元件]**&#x200B;中。

   ![](assets/email_designer_11.png)

1. 按一下您新增的元件以個人化文字，並存取電子郵件設計工具右窗格中的&#x200B;**[!UICONTROL 元件設定]**。
...
1. 調整其他樣式屬性，例如文字顏色、字型系列、邊框、邊框間距、邊界等。從「**[!UICONTROL 元件設定]**」窗格。
...
您可以從「**[!UICONTROL 元件設定]**」窗格來調整樣式屬性，例如線條顏色、樣式和高度。
...
1. 在&#x200B;**[!UICONTROL 內容元件]**&#x200B;中，將&#x200B;**[!UICONTROL 影像]**&#x200B;拖放到&#x200B;**[!UICONTROL 結構元件]**&#x200B;中。

   ![](assets/email_designer_9.png)

1. 按一下「**[!UICONTROL 瀏覽]**」從您的資產中選擇影像檔案。

1. 按一下您新增的元件，然後使用「**[!UICONTROL 元件設定]**」窗格設定影像屬性：
...
1. 調整其他樣式屬性，例如邊界、邊框等。或新增連結以將對象重新導向到「**[!UICONTROL 元件設定]**」窗格中的另一個內容。
...
1. 在「**[!UICONTROL 元件設定]**」窗格的「**[!UICONTROL 社交]**」欄位中，選擇要新增或移除的社交媒體。
...
1. 調整其他樣式屬性，例如樣式、邊界、邊框等。從「**[!UICONTROL 元件設定]**」窗格。

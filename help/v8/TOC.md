...
+ 訊息和傳遞 {#msg}
  ...
  + LINE {#line}
    + [開始使用LINE](line/get-started-line.md)
    + [傳送LINE訊息](line/send-line.md)
...
+ 內容管理 {#content}
  ...
  + 產生內容 {#ai-assistant}
    + [使用產生內容](content/generative-gs.md)
...
+ 工作流程 {#wf}
  ...
  + 使用工作流程活動 {#design-workflows}
    ...
    + [核准](workflows/activities/approval.md)
    ...
    + [資料載入 (RDBMS)](workflows/activities/data-loading-rdbms.md)

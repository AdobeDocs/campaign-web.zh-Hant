...
1. 從 **[!UICONTROL 範本]** 下拉式清單，選取 **[!UICONTROL 預設]**.

   ![](assets/rich_push_default.png)

1. 若要撰寫訊息，請在 **[!UICONTROL 標題]** 和 **[!UICONTROL 訊息]** 欄位。

   ![](assets/rich_push_default_2.png)

1. 使用運算式編輯器來定義內容、個人化資料及新增動態內容。 [了解更多](../personalization/personalize.md)

1. 定義 **[!UICONTROL 點按動作]** 與使用者點按您的通知相關聯。 這會決定使用者與通知互動時的行為，例如開啟特定畫面或在應用程式中執行特定動作。

1. 若要進一步個人化您的推播通知，您可以選擇 **[!UICONTROL 影像]** 要新增至推播通知和通知的URL **[!UICONTROL 圖示]** 以在設定檔的裝置上顯示。

   ![](assets/rich_push_default_3.png)

1. 設定 **[!UICONTROL 進階設定]** 的預設值。 [了解更多](#push-advanced)

定義訊息內容後，您可以使用測試訂閱者來預覽及測試訊息。

>[!TAB 基本範本]

1. 從 **[!UICONTROL 範本]** 下拉式清單，選取 **[!UICONTROL 基本]**.

   ![](assets/rich_push_basic.png)

1. 若要撰寫訊息，請在 **[!UICONTROL 標題]**， **[!UICONTROL 訊息]** 和 **[!UICONTROL 展開的訊息]** 欄位。

   此 **[!UICONTROL 訊息]** 文字會顯示在收合的檢視中，而 **[!UICONTROL 展開的訊息]** 在展開通知時顯示。

   ![](assets/rich_push_basic_2.png)

1. 使用運算式編輯器來定義內容、個人化資料及新增動態內容。 [了解更多](../personalization/personalize.md)

1. 新增URL以定義 **[!UICONTROL 點按動作]** 與使用者點按您的通知相關聯。 這會決定使用者與通知互動時的行為，例如開啟特定畫面或在應用程式中執行特定動作。

1. 選取 **[!UICONTROL 連結型別]** ，此URL代表您新增至 **[!UICONTROL 點按動作]** 欄位：
   ...
   * **[!UICONTROL 開啟應用程式]**：開啟應用程式URL可讓您直接連線至應用程式內的內容。 它可讓您的應用程式繞過消除歧義對話方塊，將其自身建立為特定連結型別的預設處理常式。
...
1. 按一下 **[!UICONTROL 新增按鈕]** 並填入下列欄位：

   * **[!UICONTROL 標籤]**：按鈕上顯示的文字。
   * **[!UICONTROL 連結URI]**：指定按一下按鈕時所要執行的URI。
   * **[!UICONTROL 連結型別]**：連結型別 **[!UICONTROL 網頁URL]**， **[!UICONTROL 深層連結]**，或 **[!UICONTROL 開啟應用程式]**.

   您可以選擇在推播通知中包含最多三個按鈕。 如果您選擇使用 **[!UICONTROL 「稍後提醒」按鈕]**，您最多只能包含兩個按鈕。
...
1. 從 **[!UICONTROL 範本]** 下拉式清單，選取 **[!UICONTROL 輪播]**.
...
1. 選取 **[!UICONTROL 連結型別]** ，此URL代表您新增至 **[!UICONTROL 點按動作]** 欄位：
   ...
   * **[!UICONTROL Web URL]**L：網頁URL會將使用者導向至線上內容。 按一下後，它們會提示裝置的預設網頁瀏覽器開啟並導覽至指定的URL。
...
1. 若要進一步個人化推播通知，您可以選擇通知的 **[!UICONTROL 圖示]** 以在設定檔的裝置上顯示。

1. 選擇如何 **[!UICONTROL 輪播]** 已操作：

   * **[!UICONTROL 自動]**：以投影片形式自動循環顯示影像，並以預先定義的時間間隔轉換。
   * **[!UICONTROL 手動]**：可讓使用者在幻燈片之間手動撥動，以導覽影像。

     啟用 **[!UICONTROL 影片膠捲]** 在主投影片旁加入上一個和下一個影像的預覽。

1. 按一下 **[!UICONTROL 新增影像]** 並輸入影像URL和文字。
...
| 參數 | 說明 |
|---------|---------|
| **[!UICONTROL 圖示顏色]** | 使用十六進位色彩代碼設定圖示的色彩。 |
| **[!UICONTROL 標題顏色]** | 使用十六進位色彩代碼設定標題的色彩。 |
| **[!UICONTROL 訊息文字顏色]** | 使用十六進位色彩代碼設定訊息文字的色彩。 |
| **[!UICONTROL 通知背景顏色]** | 使用十六進位色彩代碼設定通知背景的色彩。 |
...
| **[!UICONTROL 粘性通知]** | 啟動後，通知仍可見，即使使用者按一下它。 <br>如果停用，則當使用者與通知互動時，會自動解除通知。 粘性行為可讓重要通知在熒幕上持續較長時間。 |

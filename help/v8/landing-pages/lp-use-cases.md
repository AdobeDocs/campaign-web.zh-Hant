...
>title="請謹慎複製 URL"
>abstract="建立登陸頁面時，四個現成的範本可讓您實作不同的使用案例：新增或更新輪廓至行銷活動資料庫、為客戶訂閱服務、取消訂閱服務，或選擇將使用者登出。"
...
1. 在登入頁面屬性中，請務必選取&#x200B;**[!UICONTROL 使用表單]**&#x200B;中參照的資料預先填入選項，以便從設定檔預先載入任何現有資訊並避免建立重複專案。
...
1. 您可以新增&#x200B;**[!UICONTROL 核取方塊]**&#x200B;區段、選取服務並選取&#x200B;**[!UICONTROL 如果核取則取消訂閱]**&#x200B;選項。

   ![](assets/lp-uc-unsubscription-checkbox-1.png){zoomable="yes"}

1. 您也可以展開&#x200B;**[!UICONTROL 行動號召]**&#x200B;區段，並選取&#x200B;**[!UICONTROL 其他更新]**&#x200B;選項。 選取服務並核取&#x200B;**[!UICONTROL 選擇退出]**&#x200B;選項。
...
1. 從對應的下拉式清單中選取&#x200B;**[!UICONTROL 管道（電子郵件）]**，讓您的收件者僅能選擇退出電子郵件通訊。 您也可以選取&#x200B;**[!UICONTROL 依所有頻道]**，以從所有頻道的所有通訊中選取所有頻道。
...
1. 建立[電子郵件](../email/create-email.md)並[將連結](../email/message-tracking.md#insert-links)新增至您的登陸頁面，讓使用者可以選擇退出接收通訊。
